...
import com.mrxu.sql.domain.Condition;
import com.mrxu.sql.domain.Paramer;
import com.mrxu.sql.domain.Where;
import com.mrxu.sql.exception.SqlParseException;
import com.mrxu.sql.parser.WhereParser;
import com.mrxu.sql.utils.StringUtils;
    ...
    private ToXContent make(Condition cond, String name, SQLMethodInvokeExpr value) throws SqlParseException {
        ...
        switch (value.getMethodName().toLowerCase()) {
            ...
            case "score_query":
                ...
                Condition subCond = WhereParser.getConditionForMethod(value.getParameters().get(0), cond.getConn());
