...
package com.mrxu.sql.connector;

import com.mrxu.sql.exception.SemanticAnalysisException;
import com.mrxu.sql.utils.StringUtils;

import java.util.List;
import java.util.stream.Collectors;

import static com.mrxu.sql.domain.ESDataType.TYPE_ERROR;
import static com.mrxu.sql.domain.ESDataType.UNKNOWN;
